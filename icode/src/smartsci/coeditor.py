...
class CoEditor(QObject):
    ...
    def highlight_selection(self, row_from: int, col_from: int, row_to: int,
                            col_to: int, has_selection: bool,
                            selected_text: str, lines: int, all_text: str):
        if has_selection:
            ocurs = {}
    ...
    def highlight_match(self, index: int, line: int, has_selection: bool,
                        word: str, lines: int, all_text: str):
