...
from .searcher_ui import FindReplace
from smartlibs.qtmd import MovableTabData, MovableTabWidget
from .igui import notebook_corner_style
...
class NoteBookEditor(MovableTabWidget):
