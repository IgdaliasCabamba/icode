...
class Core(object):
    ...
    def run(self) -> None:
        ...
        self.file_explorer.on_file_clicked.connect(self.open_file_from_explorer)
        self.file_explorer.on_open_folder_request.connect(self.open_folder)
        self.ui.side_left.explorer.btn_close_folder.clicked.connect(self.close_folder)
        self.side_left.searcher.display.on_open_file_request.connect(
            self.open_file_from_search
        )
        self.side_left.searcher.display.on_open_folder_request.connect(self.open_folder)
