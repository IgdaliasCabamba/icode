...
class Ui_ColorPicker(object):
    ...
    def setupUi(self, ColorPicker):
        ...
        spacerItem = QtWidgets.QSpacerItem(16, 0, QtWidgets.QSizePolicy.Fixed,
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/exit.ico"), QtGui.QIcon.Normal,
                       QtGui.QIcon.Off)
        ...
        self.lastcolor_vis.setStyleSheet(
            "/* ALL CHANGES HERE WILL BE OVERWRITTEN */;\n"
    ...
    def retranslateUi(self, ColorPicker):
        ...
        self.window_title.setText(
            _translate("ColorPicker", "<strong>COLOR</strong> PICKER"))
