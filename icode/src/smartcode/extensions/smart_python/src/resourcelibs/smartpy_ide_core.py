...
EXCEPTIONS_REGEX += "BufferError||LookupError||AssertionError||AttributeError||EOFError||"
EXCEPTIONS_REGEX += "NameError"

BUILTIN_EXCEPTIONS = [
    "BaseException", "FileNotFoundError", "Exception", "ArithmeticError",
    "BufferError", "LookupError", "AssertionError", "AttributeError",
    "EOFError", "NameError"
]
...
python_extra_key_list = [
    'False', 'True', 'None', 'self', 'int', 'str', 'object', 'list', 'set',
    'dict', 'tuple', 'float', 'bool', 'byte'
]
