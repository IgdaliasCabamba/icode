...
def search_ancestor(node: "NodeOrLeaf", *node_types:
...
class NodeOrLeaf:
    ...
    def dump(self, *, indent: Optional[Union[int, str]] = 4) -> str:
        ...
        def _format_dump(node: NodeOrLeaf,
                         indent: str = "",
                         top_level: bool = True) -> str:
            result = ""
...
class Node(BaseNode):
    ...
    def __repr__(self):
        return "%s(%s, %r)" % (self.__class__.__name__, self.type,
                               self.children)
