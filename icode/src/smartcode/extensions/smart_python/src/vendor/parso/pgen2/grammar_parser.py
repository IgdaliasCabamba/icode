...
class NFAArc:
    ...
    def __init__(self, next_: "NFAState",
...
class GrammarParser:
    ...
    def __init__(self, bnf_grammar: str):
        ...
        self.generator = tokenize(bnf_grammar,
    ...
    def _expect(self, type_, value=None):
        if self.type != type_:
            self._raise_error("expected %s, got %s [%s]", type_, self.type,
                              self.value)
    ...
    def _raise_error(self, msg, *args):
        ...
        raise SyntaxError(msg,
                          ("<grammar>", self.begin[0], self.begin[1], line))
