...
class Notificator(QFrame):
    ...
    def init_ui(self):
        ...
        self.label_info.setSizePolicy(QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum))
    ...
    def update_position(self):
        y = self.view.geometry().height() - self.geometry().height() -self.view.status_bar.geometry().height()-10
