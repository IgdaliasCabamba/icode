...
class JupyterWidget(IPythonWidget):
    ...
    def set_default_style(
        self,
        style_map={"style":{"bg":"#222222", "fg":"#eeeeee", "sel":"#888"}, "syntax_style":"paraiso-dark"}
        ):
        self.style_sheet = styles.get_custom_style(style_map["style"])
        self.syntax_style = style_map["syntax_style"]
