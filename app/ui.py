...
import components.styler as styler
from functions import getfn, BASE_PATH, SYS_SEP
from gui.base import consts, parent_tab_widget
from gui.core_components import (MenuBar, NMenuBar, SideBottom, SideLeft,
                                 SideRight, StatusBar, ToolBar)
from gui.editor_widgets import EditorWidgets
...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self) -> None:
        ...
        self.div_child.setSizes([1000,1000,0])
        ...
        self.div_main.setSizes([300,1000,300])
        self.div_main.setChildrenCollapsible(True)
        self.div_main.setMinimumSize(100, 100)
