...
EDITOR_MIN_WIDTH = 100
BREADCRUMB_FIXED_HEIGHT = 24
BREADCRUMB_SHADOW_BLURRADIUS_STATE0 = 2
BREADCRUMB_SHADOW_Y_OFFSET_STATE0 = 0
BREADCRUMB_SHADOW_X_OFFSET_STATE0 = 0
BREADCRUMB_SHADOW_BLURRADIUS_STATE1 = 10
BREADCRUMB_SHADOW_Y_OFFSET_STATE1 = 0
BREADCRUMB_SHADOW_X_OFFSET_STATE1 = 3
...
ORIENTATIONS = {0: Qt.Orientation.Vertical, 1: Qt.Orientation.Vertical, 2: Qt.Orientation.Horizontal, 3: Qt.Orientation.Horizontal}
INIT_EXTESNIONS_PATTERN = "/**/__init__.json"